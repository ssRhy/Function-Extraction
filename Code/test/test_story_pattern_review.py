...
@pytest.mark.parametrize("mutate, message", [
    ...
    (lambda state: state["motif_review_queue"][0].update(snapshot_id="wrong"), "Snapshot ID"),
    (lambda state: state["motif_review_queue"][0].update(member_motif_ids=["MC_A", "UNKNOWN"]), "未知 candidate"),
