...
{
  "role_slots": ["actor"],
  "preconditions": [{"role_slots": ["actor"], "aspect": "英文大写下划线状态维度", "state": "Function 发生前必须成立的抽象状态"}],
  "effects": [{"role_slots": ["actor"], "aspect": "英文大写下划线状态维度", "before": "变化前状态", "after": "变化后状态"}],
  "obligation_effects": {
    "opens": [{"key": "英文大写下划线债务类型", "role_slots": ["actor"], "description": "新产生的未决叙事问题", "satisfied_when": "何种结果才能清偿"}],
    "advances": [{"key": "英文大写下划线债务类型", "role_slots": ["actor"], "description": "本 Function 推进但未清偿的问题", "satisfied_when": "何种结果才能清偿"}],
    "resolves": [{"key": "英文大写下划线债务类型", "role_slots": ["actor"], "description": "本 Function 能清偿的问题", "satisfied_when": "本 Function 达成的清偿结果"}]
  }
}
...
6. 不判断该 Function 是否是“结局 Function”；只描述它对状态和叙事债务的作用。
7. 至少输出一个 role_slot、一个 precondition 和一个 effect。"""
